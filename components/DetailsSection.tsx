  ...
  return (
    <section id={id} className="min-h-screen w-full bg-wine-dark relative flex flex-col pt-12 pb-24 space-y-32">
      ...
      <div className="relative z-10 w-full flex justify-center px-4">
        <div className="group relative w-full max-w-lg cursor-pointer overflow-hidden rounded-xl border border-gold-light/30 bg-black/40 backdrop-blur-sm p-12 transition-all duration-1000 animate-mystic-heartbeat">


          {/* Internal Glow Effect */}
          <div className="absolute -top-24 -right-24 h-48 w-48 rounded-full bg-gold-light/20 blur-[80px] transition-all duration-700 group-hover:bg-gold-light/30"></div>

          <div className="relative flex flex-col items-center text-center">
            {/* Mystic Icon / Symbol - Heartbeat Animation */}
            <div className="mb-8 text-gold-light animate-heartbeat">
            ...
            <p className="mb-10 font-serif text-sm italic leading-relaxed text-white/70 transition-colors duration-500 group-hover:text-white/90">
              "Lo que ves es la superficie.<br />
